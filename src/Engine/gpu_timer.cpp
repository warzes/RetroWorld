...
//=============================================================================
uint64_t gpu::TimerQuery::GetTimestamp()
{
	int complete = 0;
...
//=============================================================================
gpu::TimerQueryAsync::TimerQueryAsync(uint32_t N) : m_capacity(N)
{
	assert(m_capacity > 0);
...
//=============================================================================
gpu::TimerQueryAsync::~TimerQueryAsync()
{
	glDeleteQueries(static_cast<GLsizei>(m_capacity * 2), m_queries);
	delete[] m_queries;
}
//=============================================================================
void gpu::TimerQueryAsync::BeginZone()
{
...
//=============================================================================
void gpu::TimerQueryAsync::EndZone()
{
...
//=============================================================================
std::optional<uint64_t> gpu::TimerQueryAsync::PopTimestamp()
{
