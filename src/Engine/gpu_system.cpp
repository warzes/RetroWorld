...
bool gpu::Init()
{
	QueryGlDeviceProperties(DeviceInfo);
	core::Print("Vendor: " + std::string(DeviceInfo.vendor));
	core::Print("Renderer: " + std::string(DeviceInfo.renderer));
	core::Print("OpenGL version supported: " + std::string(DeviceInfo.version));
...
//=============================================================================
void gpu::QueryGlDeviceProperties(DeviceProperties& properties)
{
